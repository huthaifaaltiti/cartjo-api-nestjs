export const orderReturnedTemplate = {
  subject: {
    en: 'Order Return - CartJO ↪️',
    ar: 'إرجاع الطلب - كارت جو ↪️',
  },
  html: {
    en: `<div style="max-width:600px;margin:0 auto;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;background-color:#f8f9fa;">
        ...
        <div style="background-color:#ffffff;padding:40px 30px;">
            ...
            <p style="color:#666;font-size:16px;line-height:1.6;">
                We would like to inform you that your order <strong>{{orderId}}</strong> has been <strong>successfully returned</strong>.
            </p>

            <p style="color:#666;font-size:16px;line-height:1.6;">
We would like to inform you that the amounts paid for this order have been refunded to you in accordance with our usage policy.            </p>
    ...
    ar: `<div style="max-width:600px;margin:0 auto;font-family:'Cairo','Segoe UI',Arial,sans-serif;background-color:#f8f9fa;direction:rtl;">
        ...
        <div style="background-color:#ffffff;padding:40px 30px;text-align:right;">
            ...
            <p style="color:#666;font-size:16px;line-height:1.8;">
                نود إعلامك بأنه تم <strong>إرجاع طلبك رقم {{orderId}}</strong> بنجاح.
            </p>

            <p style="color:#666;font-size:16px;line-height:1.8;">
                ونود إعلامك بأن المبالغ المدفوعة لهذا الطلب قد تم إعادتها إليك طبقا لسياسة الاستخدام الخاصة بنا 
            </p>
            ...
            <p style="text-align:center;color:#666;margin-top:30px;">
                نقدّر تعاملك معنا ونتطلع لخدمتك مرة أخرى 🤍
            </p>

export const orderDeliveryFailedTemplate = {
  subject: {
    en: '⚠️ Delivery Attempt Failed',
    ar: '⚠️ تعذّر توصيل طلبك',
  },
  html: {
   ...
   <div style="background-color: white; padding: 40px 30px;">
     ...
     <p style="color:#666;font-size:16px;line-height:1.6;">
      Unfortunately, we were unable to deliver your order <strong>{{orderId}}</strong>.
    </p>
        <p style="color:#666;font-size:16px;line-height:1.6;">
      This may be due to an unavailable address, unreachable phone number, or delivery timing.
      Don’t worry — our team will contact you shortly to arrange a new delivery.
    </p>
...
<div style="background-color:#ffffff;padding:40px 30px;text-align:right;">
    <h2 style="color:#333;margin-bottom:10px;">مرحبًا {{firstName}} 👋</h2>

   <p style="color:#666;font-size:16px;line-height:1.8;">
      نأسف لإبلاغك بأنه تعذّر توصيل طلبك رقم <strong>{{orderId}}</strong>.
    </p>

    <p style="color:#666;font-size:16px;line-height:1.8;">
      قد يكون السبب عدم توفر العنوان أو تعذّر التواصل. سيقوم فريقنا بالتواصل معك قريبًا لإعادة الترتيب.
    </p>

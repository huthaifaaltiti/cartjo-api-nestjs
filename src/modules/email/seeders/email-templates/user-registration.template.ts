export const userRegistrationTemplate = {
  ...
  html: {
   ...
   <div style="background-color:#ffffff;padding:40px 30px;text-align:left;">
      ...
      <!-- Help Section -->
      <div style="text-align:center;margin:28px 0 20px 0;padding:20px;background-color:#f8f9fa;border-radius:12px;">
      ...
      <div style="text-align:center;padding:24px 0;border-top:1px solid #e9ecef;margin-top:24px;">
         ...
         <div>
            <a href="{{xLink}}" style="margin:0 5px;text-decoration:none;">
               <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#764ba2" class="bi bi-twitter-x" viewBox="0 0 16 16">
                  <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
               </svg>
            </a>
            <a href="{{facebookLink}}" style="margin:0 5px;text-decoration:none;">
               <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#764ba2" class="bi bi-facebook" viewBox="0 0 16 16">
                  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
               </svg>
            </a>
            <a href="{{instagramLink}}" style="margin:0 5px;text-decoration:none;">
               <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#764ba2" class="bi bi-instagram" viewBox="0 0 16 16">
            ...
            <a href="{{snapchatLink}}" style="margin:0 5px;text-decoration:none;">
               <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#764ba2" class="bi bi-snapchat" viewBox="0 0 16 16">
            ...
            <a href="{{linkedInLink}}" style="margin:0 5px;text-decoration:none;">
               <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#764ba2" class="bi bi-linkedin" viewBox="0 0 16 16">
            ...
            <a href="{{tiktokLink}}" style="margin:0 5px;text-decoration:none;">
               <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#764ba2" class="bi bi-tiktok" viewBox="0 0 16 16">
...
<div style="background-color:#ffffff;padding:40px 30px;text-align:right;">
   ...
   <div style="background-color:#f8f9fa;border-right:4px solid #667eea;padding:15px 20px;margin:20px 0;">
      <p style="color:#555;font-size:14px;margin:0;line-height:1.7;">
         ...
         يرجى التّحقُّق من بريدك الإلكتروني المستخدم للتسجيل معنا، لتفعيل حسابك والبدء بالتّسوIق.
      </p>
   </div>
   <div style="text-align:center;margin:30px 0;">
      <a

export const orderOutForDeliveryTemplate = {
  ...
  html: {
   ...
   <div style="background-color: white; padding: 40px 30px;">
      ...
      <p style="color: #666; font-size: 16px; line-height: 1.6; margin-bottom: 20px;"> Great news! Your order <strong>{{orderId}}</strong> is now <strong>out for delivery</strong> and will reach you soon. </p>
      <p style="color: #666; font-size: 16px; line-height: 1.6; margin-bottom: 20px;"> You can track your order anytime using the button below: </p>
     ...
     <p style="color: #999; font-size: 13px; line-height: 1.6;"> If the button doesn’t work, copy and paste this link into your browser:<br /> <a href="{{orderUrl}}" style="color: #667eea; word-break: break-all;"> {{orderUrl}} </a> </p>
     <p style="color: #666; font-size: 15px; text-align:center;"> Thank you for shopping with <strong>CartJO</strong> 🛒 </p>
   </div>
   <!-- Footer -->
   <div style="max-width:600px;margin:0 auto;font-family:'Segoe UI',Arial,sans-serif;background-color:#f8f9fa;direction:ltr;">
      <div style="background-color:#ffffff;text-align:left;">
         ...
         <div style="text-align:center;padding:24px 0;border-top:1px solid #e9ecef;margin-top:24px;">
            <p style="color:#666;font-size:14px;margin:0 0 16px 0;font-weight:600;"> Follow us for exclusive offers 🎉 </p>
            <div>
...
<p style="color:#666;font-size:16px;line-height:1.8;margin-bottom:20px;"> يسعدنا إبلاغك بأن طلبك رقم <strong>{{orderId}}</strong> قد تم شحنه وهو الآن في الطريق إليك 🚚 </p>
...
<p style="color: #666; font-size: 15px; text-align:center;"> شكرًا لتسوقك من CartJO 🛒 </p>
<div></div>
<!-- Footer -->

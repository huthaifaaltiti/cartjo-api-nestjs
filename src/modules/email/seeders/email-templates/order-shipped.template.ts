export const orderShippedTemplate = {
  subject: {
    en: '🚚 Your CartJO Order Has Been Shipped',
    ar: 'تم شحن طلبك بنجاح من CartJO 🚚',
  },
  html: {
   ...
   <div style="background-color: white; padding: 40px 30px;">
      ...
      <p style="color: #666; font-size: 16px; line-height: 1.6; margin-bottom: 20px;">
         ...
         has been shipped to you, and is on it's way to you.
      </p>
      <p style="color: #666; font-size: 16px; line-height: 1.6; margin-bottom: 20px;">
         You can track your order any time:
      </p>
...
<p style="color: #666; font-size: 16px; line-height: 1.8; margin-bottom: 20px;"> يسعدنا إعلامك بأن طلبك رقم <strong>{{orderId}}</strong> قد تم شحنه وهو الآن في الطريق إليك.</p>
